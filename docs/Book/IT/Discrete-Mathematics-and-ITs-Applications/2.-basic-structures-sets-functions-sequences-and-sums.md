...
>   * Set builder
>     * $$C=\{x \in \mathbf{Z^+}| x \text{ is odd positive integer less than }10\}$$$$C=\{x\in a | x \text{is odd positive integer less than }10\}$$
>
...
>   Example
>
>   ![image-20250509095503675](img/2.-basic-structures-sets-functions-sequences-and-sums/image-20250509095503675.png)
