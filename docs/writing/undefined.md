...
<figure><img src="../.gitbook/assets/image (134).png" alt="" width="188"><figcaption><p>소프트웨어 스펙의 모든 것</p></figcaption></figure>
...
<img src="../.gitbook/assets/file.excalidraw (3).svg" alt="프로젝트에서 SRS의 위치" class="gitbook-drawing">
